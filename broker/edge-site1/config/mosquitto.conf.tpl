...
certfile /mosquitto/certs/edge-broker-site1.crt
keyfile  /mosquitto/certs/edge-broker-site1.key
tls_version tlsv1.2
...
# BRIDGE: site1 -> cloud
# ===========================================================================
connection bridge-site1-to-cloud
...
remote_clientid bridge-site1
remote_username bridge-site1
...
notifications true
notification_topic sites/site1/bridge/state
bridge_attempt_unsubscribe false

# --- topic map ------------------------------------------------------------
#   topic <pattern> <direction> <qos>
# Direction is from the perspective of THIS (edge) broker.
# Every mapping is scoped to sites/site1/ -- with the site first in the topic,
...
topic sites/site1/telemetry/+ out 1
